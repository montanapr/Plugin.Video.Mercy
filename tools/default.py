                    ...
                    if cat != "":  # Controlamos el caso de subcategoría de canales
                        if busqueda == 'search.txt':                            
                            if url.find("allmyvideos") >= 0:
                                ...
                                title = title[0]
                                title = title.strip()                            
                                plugintools.add_item( action = "vk" , title = '[COLOR white]' + title + '[COLOR lavender] [Vk][/COLOR][I][COLOR lightsalmon] (' + origen + ')[/COLOR][/I]', url = url ,  thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True )
                                data = file.readline()
                                i = i + 1
                                continue
                                ...
                                url = url.strip()
                                print 'url',url
                                plugintools.add_item( action = "runPlugin" , title = '[COLOR white]' + title + ' [[COLOR red]You[COLOR white]tube Video][I] (' + origen + ')[/I][/COLOR]', url = url ,  thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True )
                                data = file.readline()
                                i = i + 1
                                continue

                            elif url.endswith("m3u8") >= 0:
                                title = title.split('"')
                                title = title[0]
                                title = title.strip()                            
                            ...
                            if url.startswith("serie") == True:
                                ...
                                title = title[0]
                                title = title.strip()                            
                                plugintools.add_item( action = "vk" , title = '[COLOR white]' + title + '[COLOR lavender] [Vk][/COLOR]', url = url ,  thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True )
                                data = file.readline()
                                i = i + 1
                                continue
                                ...
                                url = url.strip()
                                print 'url',url
                                plugintools.add_item( action = "runPlugin" , title = '[COLOR white]' + title + ' [[COLOR red]You[COLOR white]tube Video][/COLOR]', url = url ,  thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True )
                                data = file.readline()
                                i = i + 1
                                continue                            
                        ...
                        if busqueda == 'search.txt':
                            if url.find("allmyvideos") >= 0:
                                ...
                                url = url.strip()
                                print 'url',url
                                plugintools.add_item( action = "runPlugin" , title = '[COLOR white][' + title + ' [[COLOR red]You[/COLOR][COLOR white]tube Video][I] (' + origen + ')[/I][/COLOR]', url = url ,  thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True )
                                data = file.readline()
                                i = i + 1
                                continue                          
                            ...
                            if url.find("allmyvideos") >= 0:                                
                                ...
                                url = 'plugin://plugin.video.youtube/?path=/root/video&action=play_video&videoid=' + videoid
                                url = url.strip()
                                plugintools.add_item( action = "runPlugin" , title = '[COLOR white]' + title + ' [COLOR white][[COLOR red]You[/COLOR][COLOR white]tube Video][/COLOR]', url = url ,  thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True )
                                data = file.readline()
                                i = i + 1
                                continue 
    ...
    while i <= num_items:        
        if data == "":
            ...
            if data.startswith("sop") == True:
                ...
                plugintools.add_item(action="play" , title = title_fixed + ' [COLOR lightblue][Acestream][/COLOR]' , url = url, thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True)
                data = file.readline()
                data = data.strip()
                i = i + 1
                #print i
