# -*- coding: utf-8 -*-
#------------------------------------------------------------
# PvrGoku - XBMC Add-on by PvrGoku (mariorobles1989@gmail.com)
...
home = xbmc.translatePath(os.path.join('special://home/addons/Plugin.Video.Goku/', ''))
tools = xbmc.translatePath(os.path.join('special://home/addons/Plugin.Video.Goku/resources/tools', ''))
addons = xbmc.translatePath(os.path.join('special://home/addons/', ''))
art = xbmc.translatePath(os.path.join('special://home/addons/Plugin.Video.Goku/art', ''))
tmp = xbmc.translatePath(os.path.join('special://home/addons/Plugin.Video.Goku/tmp', ''))
...
def main_list(params):
    plugintools.log("[Goku].main_list "+repr(params))
  
    # Control del skin de Goku
    mastermenu = xml_skin()
    plugintools.log("XML menu: "+mastermenu)
    try:
        data = plugintools.read(mastermenu)
    except:
        mastermenu = 'http://pastebin.com/raw.php?i=33TTSsnq'
        data = plugintools.read(mastermenu)
        xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('Goku', "XML no reconocido...", 3 , art+'icon.png'))    
...
def play(params):
    plugintools.log("[Goku].play "+repr(params))
...
def live_items_withlink(params):
    plugintools.log("[Goku].live_items_withlink "+repr(params))
...
def xml_lists(params):
    plugintools.log("[Goku].xml_lists "+repr(params))
    data = plugintools.read( params.get("url") )
...
def getstreams_now(params):
    plugintools.log("[Goku].getstreams_now "+repr(params))
...
def livestreams_subchannels(params):
    plugintools.log("[Goku].livestreams_subchannels "+repr(params))
...
def simpletv_items(params):
    plugintools.log("[Goku].simpletv_items "+repr(params))
    ...
    if title == 'search.txt':
        ...
        data = file.readline()
        if data == "":
            ok = plugintools.message("Goku", "Sin resultados")
            return ok
    else:
        title = params.get("title")
...
def myplaylists_m3u(params):  # Mis listas M3U
    plugintools.log("[Goku].myplaylists_m3u "+repr(params))
    thumbnail = params.get("thumbnail")
...
def playlists_m3u(params):  # Biblioteca online
    plugintools.log("[Goku].playlists_m3u "+repr(params))
    data = plugintools.read( params.get("url") )
...
def getfile_http(params):  # Descarga de lista M3U + llamada a simpletv_items para que liste los items
    plugintools.log("[Goku].getfile_http "+repr(params))
    url = params.get("url")
    params["ext"] = "m3u"
    getfile_url(params)
...
def getfile_url(params):
    plugintools.log("[Goku].getfile_url " +repr(params))
    ext = params.get("ext")
    title = params.get("title")
...
def header_xml(params):
    plugintools.log("[Goku].header_xml "+repr(params))
...
def search_channel(params):
    plugintools.log("[Goku].search " + repr(params))
    ...
    if buscar == "":
        ...
        cat = ""
        if texto == "":
            errormsg = plugintools.message("PvrGoku","Por favor, introduzca el canal a buscar")
            return errormsg
...
def agendatv(params):
    plugintools.log("[Goku].agendatv "+repr(params))
...
def plx_items(params):
    plugintools.log("[Goku].plx_items" +repr(params))
...
def p2p_items(params):
    ...
    data = plugintools.read("http://pastebin.com/raw.php?i=33TTSsnq")
...
def contextMenu(params):
    plugintools.log("[Goku].contextMenu " +repr(params))
    ...
    if len_canales == 1:        
        ...
        if len_canales == 2:
            ...
            selector = dialog.select('Goku', [tv_a, tv_b])
            ...
            selector = dialog.select('Goku', [tv_a, tv_b, tv_c])
            ...
            selector = dialog.select('Goku', [tv_a, tv_b, tv_c, tv_d])
            ...
            selector = dialog.select('Goku', [tv_a, tv_b, tv_c, tv_d, tv_e])
            ...
            selector = dialog.select('Goku', [tv_a , tv_b, tv_c, tv_d, tv_e, tv_f])
            ...
            selector = dialog.select('Goku', [tv_a , tv_b, tv_c, tv_d, tv_e, tv_f, tv_g])
...
def magnet_items(params):
    plugintools.log("[Goku].magnet_items" +repr(params))
...
def parse_channel(txt):
    plugintools.log("[Goku].encode_string: "+txt)
...
def futbolenlatv_manana(params):
    plugintools.log("[Goku].futbolenlatv " + repr(params))
...
def parser_title(title):
    plugintools.log("[Goku].parser_title " + title)
...
def json_items(params):
    plugintools.log("[Goku].json_items "+repr(params))
    data = plugintools.read(params.get("url"))
...
def youtube_playlists(params):
    plugintools.log("[Goku].youtube_playlists "+repr(params))
...
def youtube_videos(params):
    plugintools.log("[Goku].youtube_videos "+repr(params))
...
def server_rtmp(params):
    plugintools.log("[Goku].server_rtmp " + repr(params))
...
def launch_rtmp(params):
    plugintools.log("[Goku].launch_rtmp " + repr(params))
...
def peliseries(params):
    plugintools.log("[Goku].peliseries " +repr(params))
...
def tinyurl(params):
    plugintools.log("[Goku].tinyurl "+repr(params))
    ...
    xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('PvrGoku', "Redireccionando enlace...", 3 , art+'icon.png'))
...
def seriecatcher(params):
    plugintools.log("[Goku].seriecatcher "+repr(params))
...
def GetSerieChapters(params):
    plugintools.log("[Goku].GetSerieChapters "+repr(params))
...
def GetSerieLinks(fanart , url_cap_fixed, i, title_fixed):
    plugintools.log("[Goku].GetSerieLinks")
...
def SelectTemp(params, temp):
    plugintools.log("[Goku].SelectTemp "+repr(params))
    ...
    if seasons == 1:
        selector = dialog.select('Goku', [temp[0]])
                                             
    if seasons == 2:
        selector = dialog.select('Goku', [temp[0], temp[1]])
                                             
    if seasons == 3:
        selector = dialog.select('Goku', [temp[0],temp[1], temp[2]])
                                             
    if seasons == 4:
        selector = dialog.select('Goku', [temp[0], temp[1],temp[2], temp[3]])
                                             
    if seasons == 5:
        selector = dialog.select('Goku', [temp[0], temp[1],temp[2], temp[3], temp[4]])
        
    if seasons == 6:
        selector = dialog.select('Goku', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5]])
        
    if seasons == 7:
        selector = dialog.select('Goku', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6]])
        
    if seasons == 8:
        selector = dialog.select('Goku', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7]])
        
    if seasons == 9:
        selector = dialog.select('Goku', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8]])
        
    if seasons == 10:
        selector = dialog.select('Goku', [temp[0], temp[1],temp[2], temp[3], temp[4], temp[5], temp[6], temp[7], temp[8], temp[9]])                               
...
def m3u_items(title):
    plugintools.log("[Goku].m3u_items= "+title)
...
def xml_skin():
    ...
    if xmlmaster == 'true':
        if SelectXMLmenu == '0':
            mastermenu = 'http://pastebin.com/raw.php?i=33TTSsnq'
            plugintools.log("[Goku.xml_skin: "+SelectXMLmenu)
            ...
            if id_pastebin == "":
                plugintools.log("[Goku.xml_skin: No definido")                
                mastermenu = 'http://pastebin.com/raw.php?i=33TTSsnq'
            else:                
                mastermenu = 'http://pastebin.com/raw.php?i=' +id_pastebin
                plugintools.log("[Goku.xml_skin: "+mastermenu)
        elif SelectXMLmenu == '5':   # Personalizado
            mastermenu = 'http://pastebin.com/raw.php?i=33TTSsnq'
            if mastermenu == "":
                plugintools.log("Goku.xml_skin: No definido")
                mastermenu = 'http://pastebin.com/raw.php?i=33TTSsnq'                
                # Control para ver la intro de Goku
                ver_intro = plugintools.get_setting("ver_intro")
                if ver_intro == "true":
                    xbmc.Player(xbmc.PLAYER_CORE_AUTO).play(art + 'intro.mp4')                        
            ...
            if mastermenu == "":
                plugintools.log("[Goku.xml_skin: No definido")
                mastermenu = 'http://pastebin.com/raw.php?i=33TTSsnq'  # Cargamos WIP                  
                # Control para ver la intro de Goku
                ver_intro = plugintools.get_setting("ver_intro")
                if ver_intro == "true":
                    xbmc.Player(xbmc.PLAYER_CORE_AUTO).play(art + 'intro.mp4')  
